...
import finalProject.BrowsingInventory.OnlyNumberAllowedKeyListener;
import finalProject.BrowsingInventory.SearchButtonListener;
...
public class BrowsingInventory extends JFrame {
    ...
    public BrowsingInventory(String dealerID) {
        ...
        inventoryDao = getInventory(dealerID);
    ...
    private InventoryDAO getInventory(String dealerID) {
